...
SWIFT_OPENAPI_GENERATOR_GIT_TAG ?= 1.10.3
...
OUTPUT_DIRECTORY ?= $(CURRENT_MAKEFILE_DIR)/Sources/SupabaseAuthHTTP/Generated
...
help:  # Display this help.
	...
	@-+echo "  OUTPUT_DIRECTORY (e.g. Sources/SupabaseAuthHTTP/Generated)"
